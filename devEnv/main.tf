module "network" {
  ...
  main_subnet_ilb_1a_cidr   = "10.0.200.0/24"
  main_subnet_ilb_1b_cidr   = "10.0.201.0/24"
...
module "app" {
  ...
  vpc_id                = module.network.main_vpc_id
  subnets               = [module.network.main_subnet_ilb_1a_id, module.network.main_subnet_ilb_1b_id]
